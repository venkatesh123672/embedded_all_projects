 ...
 * $Revision: 6 $
 * $Date: 16/10/17 9:32p $
 * @brief    M0564 series Timer Controller(Timer) driver source file
 *
 * @note
...
/**
  ...
  *
  * @param[in]  timer           The pointer of the specified Timer module. It could be TIMER0, TIMER1, TIMER2, TIMER3.
  * @param[in]  u32DropCount    This parameter has no effect in M0564 series BSP.
  * @param[in]  u32Timeout      This parameter has no effect in M0564 series BSP.
