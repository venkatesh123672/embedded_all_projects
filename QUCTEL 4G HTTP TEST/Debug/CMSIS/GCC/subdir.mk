...
S_UPPER_SRCS += \
../CMSIS/GCC/startup_M0564.S 

OBJS += \
./CMSIS/GCC/_syscalls.o \
./CMSIS/GCC/startup_M0564.o 

S_UPPER_DEPS += \
./CMSIS/GCC/startup_M0564.d 
...
CMSIS/GCC/%.o: ../CMSIS/GCC/%.S CMSIS/GCC/subdir.mk
	...
	arm-none-eabi-gcc -mcpu=cortex-m0 -mthumb -Og -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g -x assembler-with-cpp -I"../Library/CMSIS/Include" -I"../Library/Device/Nuvoton/M0564/Include" -I"../Library/StdDriver/inc" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
